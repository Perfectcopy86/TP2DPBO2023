...
public class Update_data extends javax.swing.JFrame {
    ...
    public Update_data(HOME_JFrame home, int id, String platform, String ceo, byte[] pic) {
        initComponents();
        jTextFieldPL.setText(platform);
        jTextFieldCEO.setText(ceo);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Logger.getLogger(Update_data.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void jButton_Update_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Update_ActionPerformed
        ...
        String query = "UPDATE company SET platform = ?, ceo = ?, pic = ? WHERE id = ?";
        try {
